...
and shaped in the frozen listshape dump. The 0x66xx block is the doorway and
...
Restored, each traceable to a quoted sentence or to the binary above:
  ...
  * all thirteen ids, their field names (the client's own dump strings) and
    every width (the deserializers, not listshape — which got this family wrong
...
MISREPORTED
-----------
⚠️ `listshape.py` is wrong about this family in two different ways, and the
