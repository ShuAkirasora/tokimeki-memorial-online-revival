...
| **Two computers.** The server runs on one machine and the game on another: a second PC, or another machine on your network. | the server machine's address on your local network, usually starting `192.168.` or `10.` |
